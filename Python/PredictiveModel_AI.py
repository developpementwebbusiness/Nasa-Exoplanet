...
for epoch in range(1, 101):   # 30 epochs example
    ...
    if val_loss < best_val_loss:
        ...
        torch.save(model.state_dict(), "best_model.pth")   # checkpoint
...
print(classification_report(trues, preds, target_names=le.classes_))  # precision, recall, f1-score per class
...
recall = TP/(TP+FP) “Of all the positives out there, how many did I catch?”
f1 score = 2*precision*recall_precision + recall (0.7> is good) harmonic mean good for class imbalanced data-sets
support = nb of items
'''
